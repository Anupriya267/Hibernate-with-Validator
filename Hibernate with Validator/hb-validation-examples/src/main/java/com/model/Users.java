...
public class Users {
	...
	private int rating;
	@NegativeOrZero(message="Invalid bloclisted status.Input number should be  negative (or) Zero")
	...
	@CreditCardNumber(message="Invalid credit card number.It should  contain 16 digit numbers")
